...
\tanggalpersetujuan{13 Januari 2021}
...
\begin{document}
    ...
    \begin{center}
        ...
        $\ldots$ \<ومن يتوكل على الله فهو حسبه> $\ldots$ \\
    ...
    \begin{abstractind}
        ...
        \noindent
        \textbf{Kata kunci}: Keyword 1, Keyword 2, Keyword 3, Keyword 4, Keyword 5
    \end{abstractind}
